...
public final class AestrellaDiagonal {
    ...
    private final double COSTO_DIAGONAL = Math.sqrt(2);
    ...
    public AestrellaDiagonal(Map map, int origenX, int origenY, int destinoX, int destinoY){
