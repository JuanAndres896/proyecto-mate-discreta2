...
public class RejillaB1 extends JPanel{
    ...
    // Constructor
    public RejillaB1(String archivo, int x_0,int y_0, int x_1, int y_1){
        ...
        AEstrellaPeso1 estrella = new AEstrellaPeso1(map,x_0,y_0,x_1,y_1);
